		...
		<div class="list-div" align='center'>
			<table id="tb1" >
                                            ...
                                            foreach($sample_arr as $v) { 
                                                ...
                                                if($begin<count($line_list) && $end<=count($line_list) ) {
                                                    ...
                                                    for($i=$begin-1;$i<=$end-1;$i++) {
                                                        foreach($line_list[$i] as $val) {
                                                            $new_line_list[$begin-1][$offset++]=$val;
                                                        }
                                                        $offset--;
                                                        if($i!=$begin-1) $new_line_list[$i]=true;
                                                    }
				...
				<tr align="center" >
					...
					<td ><input name="W1[]" type="text" value="<?php echo $W1 ?>"  /></td>
                                        <td ><input name="W2[]" type="text" value="<?php echo $W2 ?>"  /></td>
                                        <td ><input name="W3[]" type="text" value="<?php echo $W3 ?>"  /></td>
                                        <td ><input name="W4[]" type="text" value="<?php echo $W4 ?>"  /></td>
                                        <td ><input name="W5[]" type="text" value="<?php echo $W5 ?>"  /></td>
                                        <td ><input name="W6[]" type="text" value="<?php echo $W6 ?>"  /></td>
                                        <td ><input name="W7[]" type="text" value="<?php echo $W7 ?>"  /></td>
